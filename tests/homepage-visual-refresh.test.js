...
assertMatches(css, /background:\s*linear-gradient\(180deg,\s*#0a0a0a\s*0%,\s*#000000\s*100%\)/i, 'Expected gradient usage in homepage styles.');
assertMatches(css, /\.module-card[\s\S]*background-color:\s*rgba\(255,\s*255,\s*255,\s*0\.03\)/i, 'Expected translucent shared card surface.');
