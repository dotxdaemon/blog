// ABOUTME: Ensures the standalone golden matrix rain demo is present and wired for visual polish.
// ABOUTME: Confirms aesthetic requirements like gold palette, glow, trails, and katakana glyphs exist in source.
...
assert.ok(fs.existsSync(pagePath), 'Expected the golden matrix rain demo page to exist.');
...
assert.ok(/#ffd700/i.test(html), 'Expected the primary gold color to be defined.');
