...
assertMatches(homepageCss, /\.module-card[\s\S]*background-color:\s*rgba\(0,\s*0,\s*0,\s*0\.85\)[\s\S]*border:\s*1px\s*solid\s*rgba\(255,\s*255,\s*255,\s*0\.12\)[\s\S]*backdrop-filter:\s*blur\(12px\)/i, 'Expected homepage module cards to use high-contrast card treatment.');
assertMatches(homepageCss, /\.album-item[\s\S]*background-color:\s*rgba\(0,\s*0,\s*0,\s*0\.85\)[\s\S]*border:\s*1px\s*solid\s*rgba\(255,\s*255,\s*255,\s*0\.12\)[\s\S]*backdrop-filter:\s*blur\(12px\)/i, 'Expected homepage album cards to use high-contrast card treatment.');
