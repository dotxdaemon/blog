...
assertMatches(css, /@media\s*\(min-width:\s*900px\)[\s\S]*grid-template-columns:\s*repeat\(2,\s*minmax\(0,\s*1fr\)\)/i, 'Expected balanced desktop composition without dead space.');
